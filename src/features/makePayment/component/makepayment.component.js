...
export const MakePayment = ({ setLoading, setToken, cardNumber, expiryMonth, expiryYear, cvc, clientName, amount, setError, currency }) => {
    ...
    const paymentIntent = (token, cardId) => {
        ...
        fetch(BASE_URL + '/v1/payment_intents', {
            ...
            fin_result = await _parseJSON(result)
    ...
    const customerInitiate = (url, token, cardId) => {
        console.log('====================================================================================')
        console.log('============================ Starting Customer Initiate ============================')
        console.log('====================================================================================')
        ...
        fetch(BASE_URL + '/v1/customers', {
            ...
            body: 'description=My First Test Customer (created for API docs at https://www.stripe.com/docs/api)&email=' + rec_email + '&name=' + clientName //+ '&source=' + token + '&payment_method=' + cardId
        }).then(async(result) => {
    ...
    const paymentCharge = (url, customer, token, cardId) => {
        console.log('====================================================================================')
        console.log('============================== Starting Payment Charge =============================')
        console.log('====================================================================================')
        
        const charge_params = 'amount=' + amount + '&currency=' + currency + '&source=' + token + '&description=My First Test Charge (created for API docs at https://www.stripe.com/docs/api)&receipt_email=' + rec_email //+ '&customer=' + customer
